...
error <- c()
for(i in 1:100){
  cross_knn <- knn.cv(df_train_tele_norm[,-5], df_train_tele_norm[,5], k = i, l = 0, prob = FALSE, use.all = TRUE)
...
set.seed(1)
bag_tree_train <-randomForest(formula =  df_train_tele[,5] ~., data=df_train_tele, mtry=4, importance=TRUE, tree=10)
