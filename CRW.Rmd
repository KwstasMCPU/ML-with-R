...
norm_knn_accuracy <- mean(knn_tele(norm_x_train, norm_x_test, norm_y_train) == y_test_tele)
norm_knn_accuracy
```
...
```{r part_e_PCA}
norm_df_train <- cbind(norm_x_train, norm_y_train)
colnames(norm_df_train)[5] <- 'churn'
norm_df_test <- cbind(norm_x_test, norm_y_test)
...
plot_scatter(data=comp_df, x=comp_1, y=comp_2, x_lab = 'Comp.1', y_lab = 'Comp.2')
```
